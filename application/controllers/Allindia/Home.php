...
class Home extends CI_Controller {
        ...
        function index() {
                ...
                $header_data[ 'page_title' ] = "Lok Sabha 2019 election, Lok Sabha 2019 Opinion Poll, Who will be the next prime minister of India? Lok Shabha 2019 Prediction";
                $header_data[ 'page_meta_description' ] = "CrowdWisdom uses the concept of Lok Sabha Elections 2019, Lok Sabha Election Analysis, Assembly Election Analysis, Assembly Election Opinion Polls 2018 and Crowd Sources the most relevant and accurate predictions, information and advice.";
                $header_data[ 'page_img' ] = base_url() . "images/common/lok_sabha2019.PNG?t=" . time();
