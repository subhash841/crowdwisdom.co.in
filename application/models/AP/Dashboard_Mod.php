...
class Dashboard_Mod extends CI_Model {
    ...
    function get_user_forecast_details($user_id, $election_period_id, $state_id) {
        ...
        $this->db->select("sp.party_id, sp.actual_seats, sp.actual_votes, p.icon as party_icon, p.name as party, p.bilingual_name, p.local_lang, p.abbreviation, COALESCE(uf.seat_forecast,0) as seat_forecast,"
