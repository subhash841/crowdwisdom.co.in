            ...
            <div class="card z-depth-4">
                <div class="row plr15">
                    <div class="reason_cover coverleft ">
                        ...
                        <a href="<?php echo base_url() ?>Login?section=seat&e=tel" class="btn btn-black savebtn right hide-on-med-and-down">Predict now</a>
                    </div>
                    <div class="center hide-on-large-only">
                        <a href="<?php echo base_url() ?>Login?section=seat&e=tel" class="btn btn-black savebtn">Predict now</a>
                    </div>
                </div>
...
<?php if ($total_reasons > 10) { ?>
        $(function () {
            $('.mypagination').pagination({
                ...
                hrefTextPrefix: "<?= base_url() ?>Telangana/Reasons/Page/",
