...
<div class="content container"><!--style="margin-top: 100px;"-->
    <div class="row minus-m-t20 "><!--minus-m-t8-->
        <div class="col-md-9 l8 s12 plr15 equal-height">
            <form name="user_forecast" id="user_forecast" method="post">
                <div class="card z-depth-4 sm-card cust-border-7">
                    <div class="card-image">
                        <div class="game1 p15 coverleft">
                            ...
                            if ( $is_result_out == "0" ) {
                                ?>
                                <div class="float-right d-none d-md-block  d-none d-md-block">
                    ...
                    ?>
                    <!--<div class="forreasonbtn reasonlink d-none d-md-block ">
        ...
        <!--web view Blog-->
        <div class="col-md-3 l4 m12 s12 px-md-0 equal-height d-none d-md-block   d-none d-md-block">
    ...
    <div class="row"><!-- mb-9-->
        <div class="col-md-9 l8 s12 plr15 equal-height">
            <form name="user_vote_forecast" id="user_vote_forecast" method="post">
                <div class="card cust-border-7 z-depth-4 sm-card mt-0 cust-border-7">
                    <div class="card-image">
    ...
    <div class="row" id="forecast_reason" class="forecast_reason mobileview">
        <div class="col s12 plr15 equal-height">
            <div class="card cust-border-7 z-depth-4 sm-card h-auto cust-border-7">
...
<?= "var base_url='" . base_url() . "';"; ?>
        $(function () {
            ...
            get_your_voice('rated_articles_holder', 'rated_articles', 'FromTheWeb/detail/');
...
<a href="' + base_url + q + e.data[key].id + '/' + slug + '" class="d-block pb-3" ><div class="voiceimg p-5" style="background: url(' + e.data[key].image + ')  no-repeat center center;"></div><small class="category">' + e.data[key].category + '</small><h6>' + e.data[key].title + '</h6><small class="likes">' + e.data[key].total_likes + ' Likes &nbsp;&nbsp;&nbsp;&nbsp; ' + e.data[key].total_views + ' Views &nbsp;&nbsp;&nbsp;&nbsp;' + e.data[key].total_like_comment + ' Comments</small></a></div>');
            ...
            $('.rated_articles_holder-readmore').click(function (e) {
                get_your_voice('rated_articles_holder', 'rated_articles', 'FromTheWeb/detail/', $(this).attr('data-offset'));
            });
...
<script>
    $(function () {
        ...
        $("a.head-login").attr("href", "<?= base_url() ?>Login?section=seat");
        $("a.head-logout").attr("href", "<?= base_url() ?>Login/logout/seat");
            ...
            if (user_location == "") {
                ...
                $.ajax({
                    ...
                    if (result.status) {
                        ...
                        setTimeout(function () {
                            window.location.assign("../Allindia/Home?a=1");
                        }, 1000);
                    }
                });
            }
...
//                            setTimeout(function () {
//                                window.location.assign("<?= base_url(); ?>Allindia/Reasons/Page/1");
//                            }, 1000);
//                        }
//                        //setTimeout(function () {
...
//                            setTimeout(function () {
//                                window.location.assign("<?= base_url(); ?>" + result.redirect_url);
//                            }, 1500);
//                        }
//                        if (result.data == "1") {
...
//                        return false;
//                    }
//                    console.log("is_seat_forecast" + is_seat_forecast + "is_vote_forecast" + is_vote_forecast);
