    ...
    <div class="row mt-3">
        <div class='col-md-9 voice-cont'>
            <div class="raise_voice_banner row align-items-center m-0">
                ...
                <div class="col-8">
                    <div class='row align-items-center'>
                        ...
                        <div class="col-md-8">
                            <h4 class="text-white">Start Your Ask <span>Article</span></h4>
                        </div>
                        <div class="col-md-4 mt-2 mt-0-md">

                            <a class="btn btn-danger btn_create rounded-btn" href="#">Post Now</a>
                        </div>
                    </div>
                </div>
            </div>      
            ...
            <div class="blog-list-section bg-w-block py-4 d-block title-hr">
                <div class='row mx-3 my-2'>
                    <div class="col-md-4"><h4>Trending <b>Articles</b></h4></div>
        ...
        <div class="col-md-3 pl-md-0 pt-md-0 py-4">
            ...
            <div class="bg-w-block p-3  mb-3">
                <h4 class="d-block text-center">Trending <b>Articles</b></h4>
            ...
            <div class="bg-w-block p-3  mb-3">
                <h4 class="d-block text-center">Answered <b>Articles</b></h4>
                <div class="article-list">
...
<script src="<?= base_url() ?>js/rated_article.js?v=0.00"></script>