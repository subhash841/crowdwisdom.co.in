...
<div class="container mb-5 data-container poll">
            ...
            <div class="raise_voice_banner row align-items-center m-0">
                ...
                <div class="col-8">
                    <div class='row align-items-center'>
                        ...
                        <div class="col-md-8">
                            <h4 class="text-white">Ask Question on any <span>Topic</span></h4>
                        </div>
                        <div class="col-md-4 mt-2 mt-0-md">
                            <a class="btn btn-danger btn_create btn_create_question rounded-btn" href="#">Ask Now</a>
                        </div>
                    </div>
                </div>
            </div>    
            <div class="blog-list-section bg-w-block py-4 d-block mt-3">
                ...
                if (empty($data)) {
                    ...
                    <div class='row mx-3 my-2 pollcont'>
                        ...
                        ?>
                        <?php if ($data[0]['image']) { ?>
                            <div class="col-12 position-relative mb-3 text-center">
                        ...
                        <div class="col-12 ">
                                    ...
                                    <div class="row">
                                        ...
                                        if ($data[0]['user_id'] === $uid) {
                                            ...
                                            <h6 id="blogedit" class='comment-action col-12'>
                                                <a href="<?= base_url() ?>AskQuestions/raise_question/<?= $voice_id ?>" class="a-nostyle edit-voice" data-id="<?= $voice_id ?>"><small>EDIT</small>
                                                </a>
                                                <span>&nbsp;&nbsp;&#9679;&nbsp;&nbsp;</span>
                            ...
                            <div class='row mb-2 mt-3 poll-options <?= ($data[0]['is_multiple'] ? " multiple-choice" : " single-choice") ?>'>
                                <div class="col-12">
                                    <form class="form">
                                        <?php
                                        $i = 0;
                                        foreach ($data[0]['options'] as $option):
                                            ...
                                            $input = $userchoice ? "disabled" : "";
                                            $hide = "";
                                            if (!$showper)
                                                $hide = "d-none";
                                            //$class = $i > 12 ? "d-none" : "";
                                            $class = ($showper) ? "" : ($i > 12 ? "d-none" : "");
  ...
  <input type="' . ($data[0]['is_multiple'] ? "checkbox" : "radio") . '" id="choiceradio' . $choiceid . '" ' . ( in_array($choiceid, $userchoice) ? "checked" : "" ) . ' ' . $input . ' name="choiceradio" value="' . $choiceid . '" class="custom-control-input choose-option">
  <label class="custom-control-label w-100 m-0" for="choiceradio' . $choiceid . '"><span class="font-weight-400 option-name" data-id="' . $choiceid . '">' . $choice . '</span>
          <span class="font-weight-400 float-right avgval ' . $hide . '">' . $option['avg'] . '%</span></label>
</div>  
                                        </div>';
                                            $i = $i + 1;
                                        endforeach;
                                        if (count($data[0]['options']) > 12) {

                                            echo "<a href = '#' class = 'showoptions nav-link my-3 font-weight-400 text-center'><small>Show All Options</small></a>";
                                        }
                                        ?>
                                    </form>
                                </div>
                            ...
                            <div class="" id="bloglikecomment">
                                <div class="d-flex align-items-center">
                                    <?php if (!$userchoice && $data[0]['is_stop'] == '0') { ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <p>You will require minimum 25 Trust Points to raise a voice.</p>
            </div>
...
<script src="<?= base_url() ?>js/ask_questions.js?v=1.0.0"></script>
<?php
