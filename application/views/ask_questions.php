...
<div class="container mb-5 blog-list-page data-container">
    <div class="row mt-3">
            ...
            <div class="raise_voice_banner row align-items-center m-0">
                ...
                <div class="col-8">
                    <div class='row align-items-center'>
                        ...
                        <div class="col-md-8">
                            <h4 class="text-white">Start Your Ask <span>Questions</span></h4>
                        </div>
                        <div class="col-md-4 mt-2 mt-0-md">

                            <a class="btn btn-danger btn_create_question btn_create rounded-btn" href="#">Ask Now</a>
                        </div>
                    </div>
                </div>
            </div>      
        ...
        <!--<div class="col-md-3 pl-md-0 pt-md-0 py-4">
                    ...
                    <div class="bg-w-block p-3  mb-3">
                        <h4 class="d-block text-center">Answered <b>Questions</b></h4>
                        <div class="article-list">
...
<script src="<?= base_url() ?>js/ask_questions_list.js?v=0.00"></script>