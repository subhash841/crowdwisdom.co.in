    ...
    <div class="row mt-3">
        <div class='col-md-9 voice-cont'>
            ...
            <div class="blog-list-section bg-w-block py-4 d-block title-hr">
                <div class='row mx-3 my-2'>
                    <div class="col-md-3"><h4>Trending <b>Voice</b></h4></div>
        ...
        <div class="col-md-3 pl-md-0 pt-md-0 py-4">
            ...
            <div class="bg-w-block p-3  mb-3">
                <h4 class="d-block text-center"><img src="<?= base_url("images/icons/editor.png") ?>" class="img-fluid mr-2" />Editor’s <b>Choice</b></h4>
...
<script src="<?= base_url() ?>js/yourvoice.js?v=1.43"></script>