            ...
            <div class="card cust-border-7 z-depth-4">
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        <div class="float-left"><h4 class="cardheader blueheader font-weight-400">वर्तमान सीट अनुमान</h4></div>
                        <?php
                        if ( $is_result_out == "0" ) {
                                ?>
                                <div class="float-right hide-on-med-and-down d-none d-md-block ">
                                    <a href="<?php echo base_url() ?>Login?section=seat&e=mp" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn py-0">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
                ...
                <div class="card-content withtable">
                    <div class="row">
                        ...
                        foreach ( $user_avg_forecast as $avg_forecast ) {
                                echo '<div class="s12 l6 col-md-6 mb-4" data-n="' . $n . '">
                                        <div class="row">
                                            ...
                                            <div class="col-8 s8 equal-height-child"><!--s3-->
                                                <div class="" style="margin: 10px;">
                                                    <div class="vfparty">' . $avg_forecast[ 'bilingual_name' ] . '</div>
                ...
                if ( $is_result_out == "0" ) {
                        ?>
                        <div class="d-lg-none hide-on-large-only center-align text-center" style="padding-top: 20px;">
                            <a href="<?php echo base_url() ?>Login?section=seat&e=mp" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn py-0">अनुमान करें</a>
                        </div>
                        <?php
                }
    ...
    <div class="row mb-2">
        <div class="col-md-9 l8 m12 s12 plr15 equal-height">
            <div class="card cust-border-7 z-depth-4 mt-0">
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        <div class="float-left"><h4 class="cardheader blueheader font-weight-400">वर्तमान वोट अनुमान</h4></div>
                        <?php
                        if ( $is_result_out == "0" ) {
                                ?>
                                <div class="float-right hide-on-med-and-down d-none d-md-block">
                                    <a href="<?php echo base_url() ?>Login?section=vote&e=mp" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn py-0">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
                ...
                <div class="card-content withtable">
                    <div class="row">
                        ...
                        foreach ( $user_avg_forecast as $avg_forecast ) {
                                echo '<div class=" col-md-6 s12 mb-4 l6" data-n="' . $n . '">
                                        <div class="row">
                                            <div class="col-3 s3 equal-height-child"><img src="' . base_url( 'images/party_logos/' . $avg_forecast[ 'icon' ] ) . '" style="width: 68px;" class="forecast-result-logo"></div>
                                            <div class="col-8 s8 equal-height-child"><!--s3-->
                ...
                if ( $is_result_out == "0" ) {
                        ?>
                        <div class="hide-on-large-only d-lg-none center-align text-center" style="padding-top: 20px;">
                            <a href="<?php echo base_url() ?>Login?section=vote&e=mp" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn py-0">अनुमान करें</a>
                        </div>
                        <?php
                }
