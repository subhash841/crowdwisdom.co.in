        ...
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                ...
                <div class="card-content center">
                    ...
                    <div class=""><a href="<?= base_url() ?>Login?section=seat&e=mp" class="btn btn-black btn-large w40">अनुमान करें</a></div>
                </div>
            </div>
        </div>
        ...
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                ...
                <div class="card-content" style="padding:0">
                    ...
                    <div class="center-align"><a href="<?= base_url() ?>Login?section=vote&e=mp" class="btn btn-black btn-large w40">अनुमान करें</a></div>
                </div>
            </div>
        </div>
    </div>
