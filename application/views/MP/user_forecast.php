...
<div class="content container px-0"><!--style="margin-top: 100px;"-->
        ...
        <div class="col-md-9 l8 s12 plr15 equal-height">
            <form name="user_forecast" id="user_forecast" method="post">
                <div class="card cust-border-7 z-depth-4 sm-card">
                    <div class="card-image">
                        <div class="game1 p15 coverleft">
                            <div class="float-left">
                                <h4 class="mtb5 cardheader blueheader">आपका सीट अनुमान<!--Your Seat Prediction--></h4></div>
                            <?php
                            if ( $is_result_out == "0" ) {
                                    ?>
                                    <div class="float-right hide-on-med-and-down d-none d-md-block">
                                        <input class="py-0 btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn save-seat-vote-forecast" type="button" name="save_forecast" id="save_forecast" value="Save"><!--type="submit"-->
                                    </div>
                                    <?php
                            }
                            ?>
                    ...
                    if ( $is_result_out == "0" ) {
                            ?>
                            <div class="hide-on-large-only d-lg-none text-center" style="padding-top: 20px;">
                                <input class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn save-seat-vote-forecast py-0" type="button" name="save_forecast" id="save_forecast" value="Save">
                            </div>
                            <?php
                    }
                    ?>
                    <!--<div class="forreasonbtn reasonlink hide-on-med-and-down">
                        <a href="<?php echo base_url() ?>MP/Reasons/Page/1" class="">अनुमान के कारण</a>
                    </div>
    ...
    <div class="row"><!-- mb-9-->
        <div class="col l8 s12 plr15 equal-height col-md-9">
                ...
                <div class="card cust-border-7 z-depth-4 sm-card mt-0">
                    <div class="card-image">
                        <div class="game2 p15 coverleft">
                            <div class="float-left">
                                <h4 class="mtb5 cardheader blueheader"><!--Your Vote Prediction-->आपका वोट अनुमान</h4></div>
                            <?php
                            if ( $is_result_out == "0" ) {
                                    ?>
                                    <div class="float-right hide-on-med-and-down d-none d-md-block ">
                    ...
                    if ( $is_result_out == "0" ) {
                            ?>
                            <div class="hide-on-large-only center-align d-lg-none text-center" style="padding-top: 20px;">
                                <input class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn save-seat-vote-forecast py-0" type="button" name="save_forecast" id="save_forecast" value="Save">
                            </div>
                            <?php
                    }
    ...
    <div class="row mb-4" id="forecast_reason" class="forecast_reason mobileview">
            ...
            <div class="card cust-border-7 z-depth-4 sm-card cust-border-7 h-auto mt-0">
                ...
                if ( $is_result_out == "0" ) {
                        ...
                        <div class="text-center" style="padding-top: 20px;">
                            <input class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto savebtn save-seat-vote-forecast py-0" type="button" name="save_forecast_reason" id="save_forecast_reason" value="Save">
                        </div>
                        <?php
                }
                ?>
    ...
    <div id="alert_placeholder" class="fixed-bottom mx-auto col-md-5 col-10 mb-4 text-center"></div>
    <script>
...
<script>
        $(function () {
            ...
            $("a.head-login").attr("href", "<?= base_url() ?>Login?section=seat&e=mp");
            $("a.head-logout").attr("href", "<?= base_url() ?>Login/logout/mp");
                ...
                if (user_location == "") {
                    ...
                    $.ajax({
                        ...
                        if (result.status) {
                            ...
                            setTimeout(function () {
                                window.location.assign("../MP/Home?a=2");
                            }, 1000);
                        }
                    });
                }
