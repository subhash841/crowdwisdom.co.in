            ...
            <div class="card z-depth-4"> <!--style="margin-top: 100px;"-->
                <div class="row plr15">
                    <div class="reason_cover coverleft ">
                        <h3 class="f40 mtb0-30 darkblue" style="display:inline">अनुमान के कारण</h3>
                        <a href="<?php echo base_url() ?>Login?section=seat&e=ch" class="btn btn-black savebtn right hide-on-med-and-down">अनुमान करें</a>
                    </div>
                    <div class="center hide-on-large-only">
                        <a href="<?php echo base_url() ?>Login?section=seat&e=ch" class="btn btn-black savebtn">अनुमान करें</a>
                    </div>
                </div>
                    ...
                    foreach ($reasons as $key => $reason_forecast) {
                        ...
                        <table class="reasondata webview hide-on-med-and-down">
                            <tbody>
                                ...
                                <tr>
                                    <td></td>
                                    <td><p><img src="<?php echo base_url() ?>/images/common/seats.png"/>सीट</p></td>
                                    <?php
                                ...
                                <tr>
                                    <td></td>
                                    <td><img src="<?php echo base_url() ?>/images/common/votes.png"/>वोट</td>
                                    <?php
                                    foreach ($reason_forecast['forecast'] as $forecast_data):
                                        ?>
...
<?php if ($total_reasons > 10) { ?>
        $(function () {
            $('.mypagination').pagination({
                ...
                hrefTextPrefix: "<?= base_url() ?>Chhattisgarh/Reasons/Page/",
