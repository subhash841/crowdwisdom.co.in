                    ...
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                                ...
                                <div class="float-right hide-on-med-and-down  d-none d-md-block">
                                    <a href="<?php echo base_url() ?>Login?section=seat&e=ch" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto py-0 savebtn">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
                ...
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                                ?>
                                <div class="float-right hide-on-med-and-down d-none d-md-block">
                                    <a href="<?php echo base_url() ?>Login?section=vote&e=ch" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto py-0 savebtn">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
    ...
    <div class="row">
        <div class="col l4 m12 s12 plr15 equal-height hide-on-large-only d-lg-none">
            <div class="card cust-border-7 z-depth-4 padd0 overflow-hidden-x">
                ...
                <div class="my-3 load-btn-holder mt-4 text-center">
                    <a href="#" class="btn btn-outline-primary  voice-readmore rounded-btn load-more z-depth-2">Read more</a>
