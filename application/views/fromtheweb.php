            ...
            <div class="raise_voice_banner row align-items-center m-0">
                ...
                <div class="col-8">
                    <div class='row align-items-center'>
                        <div class="col-md-8">
                            <h4 class="text-white">Post The Ad / Picture with Your Comments... <span></span></h4>
                        </div>
                        <div class="col-md-4 mt-2 mt-0-md">
                            <a class="btn btn-danger btn_create rounded-btn" href="<?= base_url() . "FromTheWeb/post_article" ?>">Post Now</a> <!--btn_create_web-->
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12 position-relative">
                            ...
                            if ($data[0]['user_id'] === $uid) {
                                ...
                                <h6 id="blogedit" class='comment-action float-right mr-3'>
                                    <a href="<?= base_url() ?>FromTheWeb/post_article/<?= $did ?>" class="a-nostyle edit-voice" data-id="<?= $did ?>"><small>
                                            EDIT</small>
                                    </a>
                                    <span>&nbsp;&nbsp;&#9679;&nbsp;&nbsp;</span>
...
<script src="<?= base_url() ?>js/web.js?v=0.02"></script>