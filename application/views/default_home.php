        ...
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                ...
                <div class="card-content center">
                    ...
                    <div class=""><a href="<?= base_url() ?>Login" class="btn btn-black btn-large w40">Predict Now</a></div>
                </div>
            </div>
        </div>
                                ...
                                echo '<div class="blogs">
                                        <a href="' . $href . '" ' . $target . '>
                                            <div class="row">
                                                ...
                                                <div class="col s7">
                                                    <div class="blog-details text-upper">' . $blog_list['category_name'] . '</div>
                                                    <div class="blog-title truncate"></div>
        ...
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                ...
                <div class="card-content" style="padding:0">
                    ...
                    <div class="center-align"><a href="<?= base_url() ?>Login" class="btn btn-black btn-large w40">Predict Now</a></div>
                </div>
            </div>
        </div>
