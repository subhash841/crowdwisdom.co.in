                    ...
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                            ...
                            <div class="float-right hide-on-med-and-down d-none d-md-block">
                                <a href="<?php echo base_url() ?>Login?section=seat&e=in" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto  py-0 savebtn">Predict now</a>
                            </div>
                            <?php
                        }
                        ?>
                ...
                <div class="card-content withtable">
                    <div class="row">
                        ...
                        foreach ( $user_avg_forecast as $avg_forecast ) {
                            echo '<div class="col-md-6 s12 l6 mb-3" data-n="' . $n . '">
                                        <div class="row">
                ...
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                            ?>
                            <div class="float-right hide-on-med-and-down d-none d-md-block">
                                <a href="<?php echo base_url() ?>Login?section=vote&e=in" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto  py-0 savebtn">Predict now</a>
                            </div>
                            <?php
                        }
                        ?>
...
<script>
    $(function () {
        $("a.head-login").attr("href", "<?= base_url() ?>Login?section=seat&e=in");
