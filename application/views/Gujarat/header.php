...
<html>
    <head>
        ...
        <title>Elections Prediction - Home</title>
    ...
    <body>
                ...
                <nav class="white">
                    <div class="nav-wrapper container">
                        ...
                        <ul class="right hide-on-med-and-down">
                            ...
                            <li><a href="<?= base_url() ?>NewHome/prediction">Predictions</a></li>
        ...
        <ul id="slide-out" class="side-nav">
            ...
            <li><a href="<?= base_url() ?>NewHome/prediction" class="mobile-submenu-item">Predictions</a></li>
            <li><a href="<?= base_url() ?>Survey">Ask Questions</a></li>
            <!--<li><a href="<?php echo base_url(); ?>Forum/">WisdomForum</a></li>-->
            <li><a href="<?php echo base_url(); ?>Blogs">Your Voice</a></li>
            <?php
        ...
        <div class="banner white " style="">
            <img src="<?= base_url('images/common/lion-1.png'); ?>" class="absolute left-lion header-lions" />
            <img src="<?= base_url('images/common/lion-2.png'); ?>" class="absolute posright right-lion header-lions" />
            <div class="bannercontent">
                ...
                <div class="hands"><img src="<?= base_url('images/common/hands.png'); ?>" height="145"/></div>
