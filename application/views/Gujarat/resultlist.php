            ...
            <div class="navbar-fixed">
                <nav class="white">
                    <div class="nav-wrapper container">
                        ...
                        <a href="<?php echo base_url(); ?>Gujarat/Home/" class="brand-logo left-align">
                        ...
                        <ul class="right hide-on-med-and-down">
                            ...
                            <li><a href="<?php echo base_url(); ?>Gujarat/Home/resultlist" class="yours-ranking">Ranking</a></li>
                            ...
                            <li><a href="<?php echo base_url(); ?>Gujarat/Profile">Profile</a></li>
...
<!--        <ul id="slide-out" class="side-nav">
            <li class="center-align">
                <a href="<?php echo base_url(); ?>Gujarat/Home/" class="brand-logo">
                    <img src="<?= base_url('images/logo/red-logo.png'); ?>"/>
                </a>
            </li>
            <li><div class="divider"></div></li>
            <li><a href="<?php echo base_url(); ?>Gujarat/Home/">Home</a></li>
            <li><a href="<?php echo base_url(); ?>Forum/">Wisdom Forum</a></li>
            <li><a href="<?php echo base_url(); ?>Gujarat/Home/resultlist" class="yours-ranking">Ranking</a></li>
            <li><a style="color: #eb0100;" href="<?php echo base_url(); ?>Blogs/blogdetails">What is Crowd Wisdom?</a></li>
            <li><a href="<?php echo base_url(); ?>Home/aboutus">About Us</a></li>
