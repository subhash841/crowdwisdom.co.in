<div class="content container">
    <div class="row minus-m-t20 minus-m-t50 mb-12"><!--minus-m-t8-->
        ...
        ?>
        <div class="col l8 m12 s12 plr15 equal-height" style="max-height: 500px;">
            <div class="card z-depth-4">
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        <div class="left"><h4 class="cardheader blueheader">Current Score Prediction</h4></div>
                        <?php
                        if ($is_result_out == "0") {
                            ?>
                ...
                <div class="row" style="margin-bottom: 0;margin-top: 20px;">
                    <div class="col s12 l6">
                        <div class="row">
                            ...
                            <div class="col s3 text-upper mmax-title">Score</div>
                            <div class="col s3 text-upper mmax-title">Wicket</div>
                        </div>
                    </div>
...
//                        }
                        foreach ($user_avg_forecast as $avg_forecast) {
                            echo '<div class="col s12 l6" data-n="' . $n . '">
                                        <div class="row">
                                            ...
                                            <div class="col s3 equal-height-child"><!--s8-->
                                                <div class="sport-align team" style=""><!--margin: 10px;-->
                                                    <div class="vfseats">' . $avg_forecast['abbreviation'] . '</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col s3 equal-height-child mmax-container">
                                                <div class="max-count mmax-count sport-align sc_wkt">' . @$avg_forecast['avg_scoreforecast'] . '</div>
                                            </div>
                                            <div class="col s3 equal-height-child mmax-container">
                                                <div class="min-count mmax-count sport-align sc_wkt">' . @$avg_forecast['avg_wicketforcast'] . '</div>
                                            </div>
                                        </div>
                                    </div>';
                        }
        ...
        <div class="col l4 m12 s12 plr15 equal-height hide-on-med-and-down" style="max-height: 500px;">
    ...
    <!--    <div class="row mb-2">
            <div class="col l8 m12 s12 plr15 equal-height" style="min-height: 550px;">
                <div class="card z-depth-4">
                    <div class="card-image">
                        <div class="game1 p15 coverleft">
                            <div class="left"><h4 class="cardheader blueheader">Current Wicket Prediction</h4></div>
    <?php
    if ($is_result_out == "0") {
        ?>
                                        <div class="right hide-on-med-and-down">
                                            <a href="<?php echo base_url() ?>Login?section=wkt" class="btn btn-black savebtn">Predict now</a>
                                        </div>
        <?php
    }
    ?>
