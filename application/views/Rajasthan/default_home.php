<div class="content container">
    <div class="row minus-m-t20 mb-12"> <!--minus-m-t8-->
        <!-- Seat Prediction Card -->
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                <div class="card-image p15 game1 covercenter">
                    <div class="center-align"><h4 class="mtb5 blueheader"><!--Seat Prediction-->सीट अनुमान</h4></div>
                </div>
                <div class="card-content center">
                    <div class="" style="height: 54vh;"><img src="<?= base_url('images/common/seat-forecast.png'); ?>" style="margin: 10% 0;"/></div>
                    <div class=""><a href="<?= base_url() ?>Login?section=seat&e=rj" class="btn btn-black btn-large w40">अनुमान करें</a></div>
                </div>
            </div>
        </div>
        ...
        <div class="col l4 m12 s12 plr15 equal-height hide-on-med-and-down">
            <div class="card z-depth-4 padd0">
                <div class="card-head">
                    <div class="bloghead">आपकी आवाज</div>
                </div>
    ...
    <div class="row mb-9" style="">
        ...
        <div class="col l8 s12 plr15 equal-height">
            <div class="card z-depth-4 " >
                <div class="card-image p15 game2 covercenter">
                    <div class="center-align"><h4 class="mtb5 blueheader">वोट अनुमान</h4></div>
                </div>
                <div class="card-content" style="padding:0">
                    <div class="center-align" style="height: 54vh;"><img src="<?= base_url('images/common/vote-forecast.png'); ?>" style="margin: 10% 0;"/></div>
                    <div class="center-align"><a href="<?= base_url() ?>Login?section=vote&e=rj" class="btn btn-black btn-large w40">अनुमान करें</a></div>
                </div>
            </div>
        </div>
        ...
        <div class="col l4 s12 plr15 equal-height hide-on-med-and-down">
            <div class="card z-depth-4 padd0">
                <div class="card-head">
                    <div class="twitterhead">पुरस्कार</div>
                </div>
