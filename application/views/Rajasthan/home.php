...
<div class="content px-0 container">
    <div class="row minus-m-t20 "><!--minus-m-t8-->
        ...
        <div class="col-md-9 l8 m12 s12 plr15 equal-height">
            <div class="card cust-border-7 z-depth-4 ">
                    ...
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                                ...
                                <div class="float-right hide-on-med-and-down d-none d-md-block">
                                    <a href="<?php echo base_url() ?>Login?section=seat&e=rj" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto py-0 savebtn">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
                ...
                <!--<div class="row" style="margin-bottom: 0;margin-top: 20px;">
                    ...
                    <div class="col s12 l6 hide-on-med-and-down d-none d-md-block">
                        <div class="row">
                            <div class="col s6"></div>
                            <div class="col s2 text-upper mmax-title">MAX</div>
                            <div class="col s2 text-upper mmax-title">MIN</div>
                ...
                <!--<div class="forreasonbtn reasonlink hide-on-med-and-down d-none d-md-block">
                    <a href="<?php echo base_url() ?>Rajasthan/Reasons/Page/1" class="">अनुमान के कारण</a>
                </div>
        ...
        <div class="col-md-3 l4 m12 s12 p-md-0 equal-height hide-on-med-and-down d-none d-md-block">
                ...
                <div class="card-image">
                    <div class="game1 p15 coverleft">
                        ...
                        if ( $is_result_out == "0" ) {
                                ?>
                                <div class="float-right hide-on-med-and-down d-none d-md-block">
                                    <a href="<?php echo base_url() ?>Login?section=vote&e=rj" class="btn lg btn-outline-primary btn-primary rounded-btn mx-auto py-0 savebtn">अनुमान करें</a>
                                </div>
                                <?php
                        }
                        ?>
