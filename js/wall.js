...
$(function () {
   ...
   function autosize() {
    ...
    $("a.head-login").attr("href", base_url + "Login?section=wall");

    /* This is for detail view */
    if (id != "") {
        $("a.head-login").attr("href", base_url + "Login?section=walldetail&vid=" + id);
    }
    ...
    $(document).on("click", ".post-edit-comment", function (e) {
        ...
        _this.addClass("disabled");
        $.ajax({
            url: base_url + "Wall/update_comment",
            method: "POST",
    ...
    $(document).on("click", ".show-hide-reply", function (e) {
        ...
        $.ajax({
            url: base_url + "Wall/get_comment_replies",
            method: "POST",
    ...
    $(document).on("click", ".post-comment-reply", function (e) {
        ...
        $.ajax({
            url: base_url + "Wall/add_comment_reply",
            method: "POST",
    ...
    $(document).on("click", ".post-edit-comment-reply", function (e) {
        ...
        _this.addClass("disabled");
        $.ajax({
            url: base_url + "Wall/update_comment_reply",
            method: "POST",
    ...
    $("#cnfDeleteModal button#btn_delete_yes").on("click", function (event) {
        ...
        $.ajax({
            url: base_url + "Wall/deactive_wall",
            method: "POST",
            data: {id: id}
        }).done(function (result) {
            setTimeout(function () {
    ...
    $(".wall-action").on("click", function (e) {
        ...
        $.ajax({
            url: base_url + "Wall/add_update_action",
            method: "POST",
...
var callback_delete_comment = function (e) {
    ...
    var total_comments = parseInt($("#comentbox .total-comments-count").html());
    $.ajax({
        url: base_url + "Wall/delete_comment",
        method: "POST",
